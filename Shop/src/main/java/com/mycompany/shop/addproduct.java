...
public class addproduct extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {                                      
        String prod_id=TextBox1.getText();
        String prod_name=TextBox2.getText();
        String quantity=TextBox3.getText();
        String price=TextBox4.getText();
        String mfd = TextBox5.getText();
        String dis = TextBox6.getText();
        String prod_model = TextBox7.getText();
        ...
        try{
             ...
             String query = "insert into inventory(prod_id,prod_name,quantity,price,mfd,dis,prod_model) values('"+prod_id+"','"+prod_name+"','"+quantity+"','"+price+"','"+mfd+"','"+dis+"','"+prod_model+"')";
