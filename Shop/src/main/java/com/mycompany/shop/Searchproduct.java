...
public class Searchproduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Prod_Id", "Prod_name", "quantity", "price", "mfd", "dis", "prod_model"
            }
        ) {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\alnu41\\Desktop\\IDS 517\\Ass 5\\Shop\\src\\main\\java\\com\\mycompany\\shop\\four.png")); // NOI18N
         ...
         DefaultTableModel model = (DefaultTableModel) table.getModel();
           try {
            ...
            while(rs.next()) {
                ...
                String pmodel = rs.getString("prod_model");
                
                

               model.addRow(new Object[] {id,name,qun,price,mfd,dis,pmodel});
            }
            rs.close();
            //stmt.close();
            //con.close();
...
// TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        try{
             ...
             String query = "insert into cart(prod_id,prod_name,quantity,price,totprice) values('"+prod_id+"','"+prod_name+"','"+quantity+"','"+price+"','"+totprice+"')";
