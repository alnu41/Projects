...
public class Sell extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "prod_id", "prod_name", "quntatity", "price"
            }
        ) {
         ...
         DefaultTableModel model = (DefaultTableModel) table.getModel();
           try {
            ...
            Statement stmt = con.createStatement();
             String query = "select * from inventory where prod_id='"+ii+"' ";
...
// TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String prod_name=jTextField2.getText();
        ...
        try{
             Class.forName("java.sql.DriverManager");
             Connection con = DriverManager.getConnection("jdbc:sqlite:C:/Users/alnu41/Desktop/Course Structure New/IDS 401/Temp/SQLiteStudio/fs","root","");
             String query = "insert into sell(prod_id,prod_name,quantity,price,totprice) values('"+prod_id+"','"+prod_name+"','"+quantity+"','"+price+"','"+totprice+"')";
...
//         int flag=0;
        ...
        Class.forName("java.sql.DriverManager");
     Connection  c=DriverManager.getConnection("jdbc:sqlite:C:/Users/alnu41/Desktop/Course Structure New/IDS 401/Temp/SQLiteStudio/fs","root","");
  ...
  DefaultTableModel model = (DefaultTableModel) table.getModel();   
   ...
   ResultSet rs1 = s.executeQuery ("select quantity from  inventory where prod_id="+"'"+s1+"'");
